...
class TestSyncCLI:
    ...
    def test_sync_cli_returns_empty_on_no_confirm(self, tmp_path):
        ...
        with patch("src.app.services.instagram_folder_sync.Confirm.ask", return_value=False):
    ...
    def test_sync_cli_full_run(self, tmp_path):
        ...
        with patch("src.app.services.instagram_folder_sync.Confirm.ask", return_value=True), \
             patch("src.app.services.instagram_folder_sync.InstagramFolderSync", return_value=real_syncer):
            result = sync_instagram_folders_cli()
